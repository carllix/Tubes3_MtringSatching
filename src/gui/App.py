...
class App:
    ...
    def setup_gui(self):
        ...
        left_panel = ctk.CTkFrame(main_container, width=400, corner_radius=12)
    ...
    def setup_search_section(self, parent):
        ...
        scrollable_search = ctk.CTkScrollableFrame(parent, corner_radius=8)
    ...
    def setup_results_section(self, parent):
        ...
        # Modern scrollable frame for results
    ...
    def increase_results(self):
        ...
        if current < 20:
            self.num_matches_var.set(current + 1)
            self.update_matches_label(current + 1)
